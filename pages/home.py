...
def serve_layout():
    ...
    layout = html.Div([
        ...
        html.P('Hier findest du eine nach Produkten gruppierte Übersicht sämtlicher TI-Komponenten. Neue Daten werden alle 5 Minuten bereitgestellt. Laden Sie die Seite neu, um die Ansicht zu aktualisieren.'),
